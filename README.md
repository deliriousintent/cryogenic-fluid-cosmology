...
For detailed definitions, mechanics, and cosmological implications (Bullet Cluster, Galactic Rotation), see the **[Theoretical Framework](THEORETICAL_FRAMEWORK.md)**.

---

### **1. Introduction & Motivation**
*   **The Problem:** The tension between General Relativity (Dark Matter/Energy requirements) and Quantum Mechanics (Wavefunction Collapse/Active Gravity). Standard $\Lambda$CDM models require fine-tuning and hypothetical particles (WIMPs) that remain undetected.
...
*   **Scope Disclaimer:** *This framework does not assert that General Relativity is incorrect within the Solar System. Rather, it argues that GR represents the "High-Pressure / High-Temperature" limit of a more fundamental hydrodynamic reality. This model specifically targets the regimes where GR breaks down: singularities, galactic rotation curves, and the vacuum energy catastrophe.*
...
*   **Howl, R., Penrose, R., & Fuentes, I. (2019).** Exploring the unification of quantum theory and general relativity with a Bose-Einstein condensate. *New Journal of Physics*.
    ...
    *   Link: https://arxiv.org/html/2305.13285v2
